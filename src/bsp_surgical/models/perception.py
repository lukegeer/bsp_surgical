...
class PretrainedEncoder:
    ...
    def __call__(self, images: torch.Tensor) -> torch.Tensor:
        ...
        Empirically, CLS > patch-mean on NeedleReach (57% -> 0% when we
        switched to patch-mean). DINOv2's pretraining explicitly optimizes
        CLS to be the informative global summary; naively averaging 256+
        patch tokens dilutes the signal."""
